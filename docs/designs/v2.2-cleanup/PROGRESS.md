...
| 4a | 4 | 4.1, 4.3, 4.4, 4.5, 4.7 | pending | Foundation docs minus SPEC (ROADMAP / SECURITY / VISION / ARCH / AGENTS+CLAUDE) |
| 4b | 4 | 4.2 | pending | SPEC.md — single canonical V2 spec, delete legacy ~2900-line block (largest single doc edit) |
| 4c | 4 | 4.6, 4.8, 4.9 | pending | UX + changelog + website root (index.md + README.md) |
