...
# tap subcommands
complete -c skilltap -n '__fish_seen_subcommand_from tap; and not __fish_seen_subcommand_from add remove list init install' -a 'add' -d 'Add a tap'
complete -c skilltap -n '__fish_seen_subcommand_from tap; and not __fish_seen_subcommand_from add remove list init install' -a 'remove' -d 'Remove a tap'
complete -c skilltap -n '__fish_seen_subcommand_from tap; and not __fish_seen_subcommand_from add remove list init install' -a 'list' -d 'List taps'
complete -c skilltap -n '__fish_seen_subcommand_from tap; and not __fish_seen_subcommand_from add remove list init install' -a 'init' -d 'Scaffold a tap repo'
complete -c skilltap -n '__fish_seen_subcommand_from tap; and not __fish_seen_subcommand_from add remove list init install' -a 'install' -d 'Install skills from taps'
