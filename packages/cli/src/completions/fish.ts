...
# skills subcommands
complete -c skilltap -n '__fish_seen_subcommand_from skills; and not __fish_seen_subcommand_from info remove link unlink adopt move disable enable' -a 'info' -d 'Show skill details'
complete -c skilltap -n '__fish_seen_subcommand_from skills; and not __fish_seen_subcommand_from info remove link unlink adopt move disable enable' -a 'remove' -d 'Remove a skill'
complete -c skilltap -n '__fish_seen_subcommand_from skills; and not __fish_seen_subcommand_from info remove link unlink adopt move disable enable' -a 'link' -d 'Symlink a local skill'
complete -c skilltap -n '__fish_seen_subcommand_from skills; and not __fish_seen_subcommand_from info remove link unlink adopt move disable enable' -a 'unlink' -d 'Remove a linked skill'
complete -c skilltap -n '__fish_seen_subcommand_from skills; and not __fish_seen_subcommand_from info remove link unlink adopt move disable enable' -a 'adopt' -d 'Adopt unmanaged skills'
complete -c skilltap -n '__fish_seen_subcommand_from skills; and not __fish_seen_subcommand_from info remove link unlink adopt move disable enable' -a 'move' -d 'Move a skill between scopes'
complete -c skilltap -n '__fish_seen_subcommand_from skills; and not __fish_seen_subcommand_from info remove link unlink adopt move disable enable' -a 'disable' -d 'Disable a skill'
complete -c skilltap -n '__fish_seen_subcommand_from skills; and not __fish_seen_subcommand_from info remove link unlink adopt move disable enable' -a 'enable' -d 'Enable a skill'
complete -c skilltap -n '__fish_seen_subcommand_from skills; and not __fish_seen_subcommand_from info remove link unlink adopt move disable enable' -l global -d 'Show only global skills'
complete -c skilltap -n '__fish_seen_subcommand_from skills; and not __fish_seen_subcommand_from info remove link unlink adopt move disable enable' -l project -d 'Show only project skills'
complete -c skilltap -n '__fish_seen_subcommand_from skills; and not __fish_seen_subcommand_from info remove link unlink adopt move disable enable' -l unmanaged -d 'Show only unmanaged skills'
...
complete -c skilltap -n '__fish_seen_subcommand_from skills; and __fish_seen_subcommand_from disable' -l global -d 'Disable global skill'
complete -c skilltap -n '__fish_seen_subcommand_from skills; and __fish_seen_subcommand_from disable' -l project -d 'Disable project skill'
complete -c skilltap -n '__fish_seen_subcommand_from skills; and __fish_seen_subcommand_from disable' -xa '(skilltap --get-completions active-skills 2>/dev/null)'
complete -c skilltap -n '__fish_seen_subcommand_from skills; and __fish_seen_subcommand_from enable' -l global -d 'Enable global skill'
