...
complete -c skilltap -n '__fish_seen_subcommand_from install' -l also -xa 'claude-code cursor codex gemini windsurf' -d 'Symlink to agent dir'
...
complete -c skilltap -n '__fish_seen_subcommand_from link' -l also -xa 'claude-code cursor codex gemini windsurf' -d 'Agent symlink'
...
# create flags
complete -c skilltap -n '__fish_seen_subcommand_from create' -l template -xa 'basic npm multi' -d 'Template type'
