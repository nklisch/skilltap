...
use super::{HarnessId, ResourceId, ValidationError, validate_identifier, validate_text};
...
pub struct CompatibilityEvidence {
    ...
    pub affected_components: BTreeSet<ResourceId>,
...
impl CompatibilityEvidence {
    pub fn new(
        code: EvidenceCode,
        target: HarnessId,
        affected_components: impl IntoIterator<Item = ResourceId>,
...
pub enum CompatibilityError {
    MissingEvidence { fidelity: TransferFidelity },
    MissingConsequence { fidelity: TransferFidelity },
...
mod tests {
    ...
    fn component(value: &str) -> ResourceId {
    ...
    fn evidence() -> CompatibilityEvidence {
        CompatibilityEvidence::new(
            ...
            [component("component:lsp-typescript")],
    ...
    fn every_non_faithful_result_requires_evidence_and_a_consequence() {
        for fidelity in [
            ...
            assert_eq!(
                CompatibilityResult::new(CompatibilityClass::Unknown, fidelity, [evidence()], [],)
                    .unwrap_err(),
    ...
    fn constructor_and_deserialization_enforce_the_same_invariants() {
        ...
        let persisted = serde_json::from_str::<CompatibilityResult>(
            r#"{"compatibility":"incompatible","fidelity":"blocked","evidence":[],"consequences":[]}"#,
        )
        .unwrap_err();
    ...
    fn partial_result_serialization_is_deterministic_and_round_trips() {
        ...
        assert_eq!(
            json,
            r#"{"compatibility":"target_specific","fidelity":"partial","evidence":[{"code":"target.component.unsupported","target":"codex","affected_components":["component:lsp-typescript"],"detail":"Claude LSP components have no Codex equivalent"}],"consequences":[{"code":"component.omitted","affected_components":["component:lsp-typescript"],"summary":"The TypeScript language server will not be installed"}]}"#
        );
    }

    #[test]
    fn compatibility_wires_reject_unknown_fields_and_invalid_text() {
        let unknown = r#"{"compatibility":"compatible","fidelity":"faithful","evidence":[],"consequences":[],"assumed_safe":true}"#;
