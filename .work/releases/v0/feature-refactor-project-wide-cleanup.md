---
id: feature-refactor-project-wide-cleanup
kind: feature
stage: done
tags: [refactor]
release_binding: "0"
...
> Original design migrated from `docs/designs/completed/refactor-project-wide-cleanup.md`.
> Marked complete in commit `1ec2f6b`.
